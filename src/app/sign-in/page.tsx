          ...
          <div className="bg-white p-8 border border-earth-100 rounded-xl shadow-lg">
            ...
            <form className="space-y-4">
              <div>
                ...
                <input type="email" className="w-full px-4 py-3 border border-earth-100 rounded focus:ring-2 focus:ring-blue-500 outline-none transition-shadow" placeholder="you@example.com" />
              </div>
              <div>
                <label className="block text-sm font-medium text-earth-900 mb-1">Password</label>
                <input type="password" className="w-full px-4 py-3 border border-earth-100 rounded focus:ring-2 focus:ring-blue-500 outline-none transition-shadow" placeholder="••••••••" />
              </div>
              ...
              <div className="flex items-center justify-between text-sm mt-2">
                ...
                <Link href="#" className="flex text-blue-500 hover:text-blue-700 transition-colors">Forgot password?</Link>
              </div>
            ...
            <div className="mt-8 text-center text-sm text-muted-foreground pt-6 border-t border-earth-100">
              Don't have an account? <Link href="/register" className="text-blue-500 hover:text-blue-700 font-medium transition-colors">Create an account</Link>
            </div>
          </div>
        </div>
      </section>
