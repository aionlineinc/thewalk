...
import { CrossOverMinistryTabs } from "./CrossOverMinistryTabs";

const HERO_IMAGE =
  "https://images.unsplash.com/photo-1523437237164-d442d57cc3c9?q=80&w=2400&auto=format&fit=crop";

/**
 * Hardcoded fallback for /journey/cross-over.
 *
 * Used when Directus is unreachable or hasn't been seeded yet. Visual
 * contract is identical to the previous (pre-CMS) page so the site never
 * appears broken.
 */
export function CrossOverFallback() {
  return (
    <>
      <section
        id="cross-over-hero"
