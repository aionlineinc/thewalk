...
export const metadata: Metadata = {
  title: "Cross Connect | theWalk Ministries",
  description: "Build enduring community, fellowship, and expand into Kingdom impact.",
};

export default function CrossConnectPage() {
  return (
    <>
      <section
