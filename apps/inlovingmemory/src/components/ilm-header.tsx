  ...
  return (
    <header className="fixed inset-x-0 top-6 z-50 sm:top-7">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 md:px-8">
        <div className="flex items-center justify-between gap-4 rounded-full border border-white/25 bg-white/60 px-5 py-3 shadow-lg shadow-black/5 backdrop-blur-lg">
